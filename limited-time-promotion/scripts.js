document.addEventListener("DOMContentLoaded", function () {
  ...
  var animatedImg = document.querySelector(".animated-open");
  ...
  function copyToClipboard(text) {
    navigator.clipboard
      ...
      .then(() => {
        ...
        promoBtn.innerHTML = `<svg class="tick-copied" width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
